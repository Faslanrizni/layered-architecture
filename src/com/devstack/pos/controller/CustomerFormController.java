...
//    public TableColumn colAddress;
    ...
    public void initialize() throws SQLException, ClassNotFoundException {  /* initialize method is inbuilt method*/
        ...
        /* for columns identification we add above  code  to trigger which item ...*/
    ...
    private void setData(CustomerTm newValue) {
        txtEmail.setEditable(false);  /* this code snipt make email not editable*/
...
//        txtSalary.setText(newValue.getSalary()+"");
    ...
    private void loadAllCustomers(String searchText) throws SQLException, ClassNotFoundException {
        ...
        int counter = 1;
        for (CustomerDto dto :
                searchText.length() > 0 ? new DatabaseAccessCode().searchCustomer(searchText) : new DatabaseAccessCode().findAllCustomer()) {
                /* AFTER APPLYING DAO LAYER WE REMOVED STATIC KEY WORD FROM METHOD INILIZATION SO WE NEED TO
                * REWRITE  "DatabaseAccessCode.searchCustomer(searchText)" THIS TO  new DatabaseAccessCode().searchCustomer(searchText)
                * NOW THIS IS NOT STATIC TYPE THIS METHOD NOW INSTANT TYPE / OBJECT TYPE  */
